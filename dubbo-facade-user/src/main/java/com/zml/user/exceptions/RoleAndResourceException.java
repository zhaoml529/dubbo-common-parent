...
public class RoleAndResourceException extends ServiceException {
	...
	public static final RoleAndResourceException ADD_RAR_ERR = new RoleAndResourceException(10050001, "关联角色资源失败！");
	
	public static final RoleAndResourceException UPDATE_RAR_ERR = new RoleAndResourceException(10050002, "更新角色资源信息失败！");
