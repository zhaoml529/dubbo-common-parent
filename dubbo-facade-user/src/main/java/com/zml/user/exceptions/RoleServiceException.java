...
public class RoleServiceException extends ServiceException {
	...
	public static final RoleServiceException ADD_ROLE_FAIL = new RoleServiceException(10050001, "添加角色失败！");
	
	public static final RoleServiceException UPDATE_ROLE_FAIL = new RoleServiceException(10050002, "更新角色信息失败！");
